...
*/
  ...
  class Filial
  {
    ...
    public function CadastrarFial($filial){
      ...
      $sql = "insert into tbl_restaurante(nome, tipo_restaurante, telefone, cep, numero)";
      $sql = $sql."values('".$filial->nome."', ".$filial->tipo_restaurante.",";
      $sql = $sql."'".$filial->telefone."', '".$filial->cep."', '".$filial->numero."')";
    ...
    public function AlterarFilial($filial){
      ...
      $sql = $sql.", telefone = '".$filial->telefone."', cep = '".$filial->cep."', numero = '".$filial->numero."'";
