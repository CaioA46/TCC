...
INSERT INTO `tbl_motivo_login` VALUES (1,'Teste 1','Descricao tralala',6,1),(2,'Teste 2','lalalala',7,1),(3,'Teste 3','cupcake',8,0),(4,'Teste','LAlalala',32,1);
...
INSERT INTO `tbl_slider_img` VALUES (1,27),(1,24),(1,23),(1,25),(1,28),(1,29),(2,19),(2,21),(2,22),(2,23),(2,24),(1,20),(2,31);
...
INSERT INTO `tbl_tipo_prato` VALUES (1,'fasfafa','carne.jpg'),(2,'hamburguer','carne.jpg'),(3,'fasfasfasf','carne.jpg');
...
/*!50001 VIEW `vw_slider_img` AS select `s`.`id_slider` AS `id_slider`,`i`.`id_imagem` AS `id_imagem`,`i`.`url` AS `url` from ((`tbl_slider` `s` join `tbl_slider_img` `si` on((`si`.`id_slider` = `s`.`id_slider`))) join `tbl_imagem` `i` on((`i`.`id_imagem` = `si`.`id_img`))) */;
...
-- Dump completed on 2017-10-17 16:59:01
