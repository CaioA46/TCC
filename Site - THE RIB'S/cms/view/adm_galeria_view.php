...
<form class="adm_galeria" action="router.php?controller=galeria&modo=alterar" method="post">
  ...
  <div class="imagens">
    ...
    <div class="imagens_slide">
      <form action="router.php?controller=slider&modo=update&idslider=1" method="post" enctype="multipart/form-data">
        <div class="botao_salvar_imagem_slide">
          ...
          <a href="router.php?controller=slider&modo=novo&idslider=1" class="btn_adicionar_img_slide"  name="btn_respondido"> Adicionar </a>
          <!--
            ===================================
                ...
                <div class="imagens_dentro_do_slide1">
                  ...
                  <div class="edit_e_delete">
                      ...
                      <div class="delete">
                        ...
                        <a href="router.php?controller=slider&modo=excluir&idslider=1&idimg=<?php echo($slider->imagens[$contador]->id_imagem)?>">
