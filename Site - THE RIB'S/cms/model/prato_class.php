...
class Pratos{
    ...
    public function InsertPrato(){
        ...
        values('".$titulo."', '".$preco."', '".$descricao."', ".$idCategoria.");";
        mysql_query($sql);
            ...
            */
            ...
            while($cont < $cI){
                if(!empty($_POST['ingrediente_'.$cont])){
                    ...
                    $sql = "insert into tbl_ingrediente_produto(id_ingrediente, id_produto) values(".$idIngrediente.",".$idProduto.")";
                    mysql_query($sql);
                    echo $sql.'<br>';
                }
            ...
            if(mysql_affected_rows() > 0){
                ...
                echo 'mysql não affectou as rows';
            }
    ...
    public function UpdatePrato(){
        ...
        /* Salvar produto */
        $sql = "update tbl_produto set nome='".$titulo."', preco='".$preco."', descricao='".$descricao."', tipo_produto=".$idCategoria." where id_produto = ".$id ;
        mysql_query($sql);
        ...
        */
        ...
        $sql='delete from tbl_ingrediente_produto where id_produto='.$id;
        ...
        if(mysql_query($sql)){
            ...
            while($cont < $cI){
                if(!empty($_POST['ingrediente_'.$cont])){
                    ...
                    $idIngrediente = $_POST['ingrediente_'.$cont];
                    $sql = "insert into tbl_ingrediente_produto(id_ingrediente, id_produto) values(".$idIngrediente.",".$id.")";
                    mysql_query($sql);
                    echo $sql.'<br>';
                }
    ...
    public function SelectPratos(){
        $sql = "select p.id_produto, p.nome as titulo, i.url as imagem 
    ...
    public function SelectCategorias(){
        $sql = "select id_tipo_prato as idCategoria, nome as categoria from tbl_tipo_prato";
        ...
        if($select = mysql_query($sql)){
            ...
            while($rs = mysql_fetch_array($select)){
                ...
                $categoria[$cont]->idCategoria = $rs['idCategoria'];
                $categoria[$cont]->categoria = $rs['categoria'];
    ...
    public function SelectCategoriaPrato($id){
        $sql = "select tp.* from tbl_tipo_prato as tp
                inner join tbl_produto as p
                on tp.id_tipo_prato = p.tipo_produto where id_produto = ".$id;
        ...
        if($select = mysql_query($sql)){
            ...
            while($rs = mysql_fetch_array($select)){
                ...
                $categoria->idCategoria = $rs['id_tipo_prato'];
                $categoria->categoria = $rs['nome'];
    ...
    public function SelectIngredientePrato($id){
        $sql = "select i.* from tbl_ingrediente as i
                inner join tbl_ingrediente_produto as ip
