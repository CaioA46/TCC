...
<div class="conteudo_adm_filiais">
  ...
  <div class="cadastro_nova_filial">
    <form name="frmFilial" action="router.php?controller=filial&modo=<?php echo($action); ?>" method="post">
      <div class="nome">
      ...
      <div class="CEP">
          <input placeholder="Telefone:" name="txtTelefoneFilial" class="login_senha2" type="text" maxlength="" value="<?php echo($telefone); ?>" required/>
      ...
      <div class="entrar">
          ...
          <button class="btn_excluir" type="submit" name="btn_excluir" > Excluir </button>
      </div>
    </form>
  </div>
