...
<div id="pq_cadastrar">
    ...
    <div class="reservas">
      ...
      <div class="texto_reserva">
        <p class="titulo_reserva">Reservas</p>

        <p class="conteudo_reserva">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
           Donec aliquam elit a varius iaculis. Etiam mattis risus
           at erat blandit sollicitudin. Pellentesque ligula nunc,
           pulvinar quis iaculis non, finibus semper magna. Duis
           metus arcu, lobortis ac felis ut, porttitor mollis urna.
           Duis iaculis nulla eu viverra vestibulum. Maecenas hendreri
           mauris at erat dictum mattis. Quisque eget iaculis sapien.
           Proin et scelerisque orci. Pellentesque quis tortor fringilla
           felis venenatis mattis ac eget nunc. Curabitur euismod dapibus cursus.
          </p>
      ...
      <div class="imagem_reserva">
        ...
        <img src="imagens/motivo-01.png" alt="teste">
    ...
    <div class="brinde">
      ...
      <div class="imagem_brinde">

        <img src="imagens/motivo-02.png" alt="teste">

      </div>

      <div class="texto_brinde">
        <p class="titulo_brinde">Brinde após consumir</p>

        <p class="conteudo_brinde">
           Lorem ipsum dolor sit amet, consectetur adipiscing elit.
           Donec aliquam elit a varius iaculis. Etiam mattis risus
           at erat blandit sollicitudin. Pellentesque ligula nunc,
           pulvinar quis iaculis non, finibus semper magna. Duis
...
<div class="nao_perca_seu_tempo">


  <p class="titulo_perca"> Não perca seu tempo</p>

  <div class="imagem_perca">
